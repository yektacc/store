...
/*
  ...
  final LoginStatusBloc _loginStatusBloc = LoginStatusBloc(_loginBloc);
  ...
  final SpecialProductsRepository _bestSellerRepo = SpecialProductsRepository(net);
  ...
  final PreviousOrdersRepository _prvOrderRepository =
      PreviousOrdersRepository(net);
  final SiteInfoRepository _siteInfoRepository = SiteInfoRepository(net);
  final FavoriteBloc _favoriteBloc =
      FavoriteBloc(_loginStatusBloc, FavoriteRepository(_detailRepo),_detailRepo);
