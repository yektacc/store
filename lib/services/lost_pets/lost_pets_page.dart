...
class ProvinceCitySelectionRow extends StatefulWidget {
  ...
  ProvinceCitySelectionRow(this.onChange,
      {this.initialCity, this.initialProvince});
        ...
        new Expanded(
          child: Container(
            ...
            child: DropdownButton<Province>(
              hint: Text("استان"),
              value: currentProvince == null && widget.initialProvince != null
        ...
        new Expanded(
          child: Container(
              ...
              child: new DropdownButton<City>(
                ...
                items: currentProvince == null && widget.initialProvince != null
                    ? widget.initialProvince.cities
                        .map<DropdownMenuItem<City>>((City value) {
                        return DropdownMenuItem<City>(
                          value: value,
                          child: Text(value == null ? "شهر" : value.name),
                        );
                      }).toList()
...
class _LostPetItemWgtState extends State<LostPetItemWgt> {
  ...
  Widget build(BuildContext context) {
    ...
    persianDate =
        PersianDateTime.fromGregorian(gregorianDateTime: widget._item.lostDate.split(' ')[0]);
                                    ...
                                    child: Container(
                                      ...
                                      child: Row(
                                        children: <Widget>[
                                          ...
                                          Container(
                                            margin: EdgeInsets.only(right: 10),
                                            child: Text(persianDate.toJalaali()
                                                .toString()),
                                          )
                                        ],
                                      ),
